...
public class Tile {
	...
	// Stores the current rotation of a tile as an int, we will use constants to
	// store directional values
	// TODO
	...
	// Grid is a two dimensional array that keeps track of the zones present in
	// a given tile
	private int[][] grid;
